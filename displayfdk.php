    ...
    <section class="banner_section">
        <div class="banner-main">
          ...
          <?php
           ...
           $select_query = "CALL `getfeedback`()";
           $result = $con-> query($select_query);
           
           if($result->num_rows > 0){
              while ($row = mysqli_fetch_array($result)) {
                echo "<tr><td>".$row["service"]."</td><td>" .$row["driverservice"]."</td><td>" .$row["name"]."</td><td>" .$row["roll"]."</td><td>" .$row["phone"]."</td><td>"  .$row["feedback"]."</td><td>"."<a href=deletefdk.php?name=".$row["name"].">Delete</a>"."</td></tr>";
